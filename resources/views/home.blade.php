...
@section('content')
   ...
   <div class="sl-mainpanel">
            ...
            <div class="sl-pagebody">
                <H3>Welcome To Mamextravel Dashboard</H3>

                <span>Tour and travel agency</span>
<br><br>
<div class="row row-sm">
          <div class="col-sm-6 col-xl-3">
            <div class="card pd-20 bg-primary">
              <div class="d-flex justify-content-between align-items-center mg-b-10">
                <h6 class="tx-11 tx-uppercase mg-b-0 tx-spacing-1 tx-white">Total User & Customer</h6>
                <a href="" class="tx-white-8 hover-white"><i class="icon ion-android-more-horizontal"></i></a>
              </div><!-- card-header -->
              <div class="d-flex align-items-center justify-content-between ">
             
                <h3 class="mg-b-0 tx-white tx-lato tx-bold ">{{$total_user+$total_user}}</h3>
              </div><!-- card-body -->
              <div class="d-flex align-items-center justify-content-between mg-t-15 bd-t bd-white-2 pd-t-10">
                <div>
                  <span class="tx-11 tx-white-6">Admin User</span>
                  <h6 class="tx-white mg-b-0">{{$total_user}}</h6>
                </div>
                <div>
                  <span class="tx-11 tx-white-6">Total Customer</span>
                  <h6 class="tx-white mg-b-0">{{$total_user}}</h6>
                </div>
              </div><!-- -->
            </div><!-- card -->
